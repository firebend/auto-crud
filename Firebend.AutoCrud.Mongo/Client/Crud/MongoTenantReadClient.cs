...
public class MongoTenantReadClient<TKey, TEntity, TTenantKey> : MongoReadClient<TKey, TEntity>
    where TKey : struct
    ...
    where TTenantKey : struct
{
    ...
    public MongoTenantReadClient(IMongoClientFactory<TKey, TEntity> clientFactory,
