...
public static class ControllerExtensions
{
    ...
    public static async Task<TEntity> ValidateModel<TKey, TEntity, TCreateViewModel>(this AbstractEntityControllerBase controller,
        TCreateViewModel body,
        IViewModelMapper<TKey, TEntity, TCreateViewModel> mapper,
