...
public static partial class AbstractDbCreatorLogger
{
    ...
    public static partial void CreatingDb(this ILogger logger, string dbName, string dbSource);

    [LoggerMessage(EventId = 0, Level = LogLevel.Debug, Message = "Database Created. DbName: {dbName}. DataSource: {dbSource}")]
    public static partial void DbCreated(this ILogger logger, string dbName, string dbSource);
}
