...
public class EntityExportControllerService<TKey, TEntity, TVersion, TSearch, TMapped> :
    BaseDisposable,
    ...
    where TKey : struct
{
    ...
    public EntityExportControllerService(IEntityFileTypeMimeTypeMapper<TVersion> entityFileTypeMimeTypeMapper,
