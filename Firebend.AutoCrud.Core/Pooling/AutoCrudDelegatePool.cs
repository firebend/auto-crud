...
{
    public class AutoCrudDelegatePool
    {
        private static class DefaultDelegatePool<T>
            where T : class, new()
        {
            public static readonly ObjectPool<T> Instance = AutoCrudObjectPool.Instance.Create<T>();
        }
        ...
        {
            var obj = DefaultDelegatePool<TPooled>.Instance.Get();
            ...
            where TBoundDelegate : Delegate
        {
            ...
            public sealed override void ClearAndFree()
            {
                Argument = default!;
                UnboundDelegate = null!;
                DefaultDelegatePool<TSelf>.Instance.Return((TSelf)this);
            }
